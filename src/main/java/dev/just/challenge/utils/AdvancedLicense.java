...
public class AdvancedLicense {
	...
	private String securityKey = "4SxwLu7wr6EpCnVSPmK4qJGjxfVTMuu9zVd";
	...
	public boolean register() {
		...
		log(0, ChatColor.BLUE + "Verbinde zum Lizenz-Server" + ChatColor.GRAY + "...");
		...
		if (vt == ValidationType.VALID) {
			...
			log(1, ChatColor.RED + "Fehler aufgetreten aufgrund eines Ergebnisses von: " + ChatColor.GRAY + vt.toString());
			log(1, ChatColor.RED + "Dektiviere Plugin" + ChatColor.GRAY + "...");
			log(0, ChatColor.GRAY + "✗ " + ChatColor.BLUE + "Lizenzsystem" + ChatColor.GRAY + " ✗");
